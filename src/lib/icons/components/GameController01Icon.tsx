...
export const GameController01Icon: FC<SvgIconProps> = ({ size = 24, className }) => (
  <svg
    ...
    className={className}
  >
    <path d={"M11 13H13"} stroke={"currentColor"} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"1.5"} />
    <path d={"M12 9V3"} stroke={"currentColor"} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"1.5"} />
