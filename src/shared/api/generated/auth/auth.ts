...
/**
 * @summary Register a new user; returns user and Bearer token (store token, send in Authorization header).
 */
...
export const useAuthControllerRegister = <TError = ErrorType<void>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    /**
 * @summary Login with email and password; returns user and Bearer token (store token, send in Authorization header).
 */
...
export const useAuthControllerLogin = <TError = ErrorType<void>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    /**
 * @summary Logout user (client should clear stored token).
 */
...
export const getAuthControllerGetProfileQueryOptions = <TData = Awaited<ReturnType<typeof authControllerGetProfile>>, TError = ErrorType<void>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof authControllerGetProfile>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
