...
export const ShoppingBasket01Icon: FC<SvgIconProps> = ({ size = 24, className }) => (
  <svg
  ...
  >
    ...
    <path d={"M16 9.5C16 5.63401 14.2091 2 12 2C9.79086 2 8 5.63401 8 9.5"} stroke={"currentColor"} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"1.5"} />
  </svg>
)
