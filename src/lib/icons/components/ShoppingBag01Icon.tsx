...
export const ShoppingBag01Icon: FC<SvgIconProps> = ({ size = 24, className }) => (
  <svg
  ...
  >
    ...
    <path d={"M9 7C9 8.65685 10.3431 10 12 10C13.6569 10 15 8.65685 15 7"} stroke={"currentColor"} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"1.5"} />
  </svg>
)
