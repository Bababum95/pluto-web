...
export const Hamburger01Icon: FC<SvgIconProps> = ({ size = 24, className }) => (
  <svg
  ...
  >
    ...
    <path d={"M15.0078 7L14.9988 7"} stroke={"currentColor"} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"2"} />
    <path d={"M10.5 6.5L9.5 7.5"} stroke={"currentColor"} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"1.5"} />
  </svg>
)
